...
let IconClosePopup = document.querySelector ('.form__button_type_cross');
let ProfileNameText = document.querySelector ('.profile__name');
let ProfileCareerText = document.querySelector ('.profile__career');
let ProfileNameInput = document.querySelector ('.form__input_type_name');
let ProfileCareerInput = document.querySelector ('.form__input_type_career');
...
let jobInput = document.querySelector ('.form__input_type_career'); // Воспользуйтесь инструментом .querySelector()
